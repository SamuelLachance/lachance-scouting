...
NORTHSTAR estime Tyus Sparks à 56.07/100 pour devenir une étoile NHL (NHL régulier). Pilier dominant: plafond étoile 5.6/10.
...
**5.5/10 — Très faible** (profil depth / bust). Pilier NORTHSTAR (15%). Signaux: inférence contextuelle. Sources pondérées: DPH grade & tags (17%), DPH scouting report body (16%), DPH listed strengths (15%), DPH NHL projection (15%), Rankings dimension profile (13%). Confiance: multi-sources substantielles.

### Pouvoir offensif star — 5.9/10
**5.9/10 — Très faible** (profil depth / bust). Pilier NORTHSTAR (12%). Signaux: inférence contextuelle. Sources pondérées: DPH grade & tags (17%), DPH scouting report body (16%), DPH listed strengths (15%), DPH NHL projection (15%), Rankings dimension profile (13%). Confiance: multi-sources substantielles.
